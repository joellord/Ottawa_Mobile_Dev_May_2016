...
$$(document).on('pageInit', '.page[data-page="about"]', function (e) {
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        if (!WEATHER_API_KEY) {
            console.log("Get your OpenWeatherMap API key at http://openweathermap.org/api");
        }
        var weatherUrl = "http://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&units=metric&APPID=" + WEATHER_API_KEY;
